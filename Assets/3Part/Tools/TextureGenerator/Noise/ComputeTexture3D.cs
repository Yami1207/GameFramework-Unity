...
public class ComputeTexture3D : ComputeTexture {
    ...
    public override void GenerateTexture()
    {
        ...
        if (kernel != -1)
            computeShader.Dispatch(kernel, squareResolution / computeThreads.x, squareResolution / computeThreads.y, squareResolution / computeThreads.z);
    }
    ...
    public override void SaveAsset(){
        ...
        AssetDatabase.CreateAsset(output, "Assets/" + assetName + ".asset");
    }
}
