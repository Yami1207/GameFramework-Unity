Shader "Rendering/Character/Star Rail/Body"
{
    Properties
    {
		...
		[NoScaleOffset]_MaterialValuesPackLUT("Material Values Texture", 2D) = "white" {}
		...
		[Header(Emission)]
		[HideInInspector]_EmissionHeader("自发光", Float) = 0
        ...
        _OutlineWidth("Width", Range(0.01, 4)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			// -------------------------------------
            // 自定义keywords
			#pragma shader_feature_local _USE_MATERIAL_VALUES_PACK_LUT
			...
			//--------------------------------------
            // 自定义宏
			#define CHARACTER_BODY_PASS

            #include "CharacterBodyPass.hlsl"
